...
- (CIImage *)rotatedImage:(CIImage *)image angle:(CGFloat)angle size:(NSSize)size center:(NSPoint)center horizontal:(BOOL)horizontal {
    ...
    [darkenFilter setValue:[NSNumber numberWithDouble:-fabs(angle) / M_PI] forKey:@"inputEV"];
    ...
    [perspectiveFilter setValue:[darkenFilter valueForKey:kCIOutputImageKey] forKey:kCIInputImageKey];
